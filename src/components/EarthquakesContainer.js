  ...
  render() {
    return (
      <div className="EarthquakesContainer">
        ...
        <br />
        <p>
          <strong>This app was created with ❤️ by me, Matthew Thorry.</strong>{' '}
          Checkout the{' '}
          <a
          ...
          , my{' '}
          <a
            href="https://medium.com/front-end-hacking/using-the-google-maps-javascript-api-in-a-react-project-b3ed734375c6"
            target="_blank"
            rel="noopener noreferrer"
          >
            blog post
          ...
          about this, or my{' '}
          <a
            href="https://www.linkedin.com/in/mthorry/"
            target="_blank"
            rel="noopener noreferrer"
          >
            LinkedIn
